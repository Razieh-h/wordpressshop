...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('content-bg1', 'html5blank'),
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id' => 'content-bg1',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
    ...
    register_sidebar(array(
        'name' => __('text-choose', 'html5blank'),
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id' => 'text-choose',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
    ...
    register_sidebar(array(
        'name' => __('articles-cat', 'html5blank'),
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id' => 'articles-cat',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
