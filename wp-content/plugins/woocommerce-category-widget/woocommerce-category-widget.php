				...
				foreach ($all_categories as $cat) {
				    ...
				    if($cat->category_parent == 0) {
							...
							{  
								...
								echo '<div class="joomir-div"><div class="card__inner"><a href="'. get_term_link($cat->slug, 'product_cat') .'" class="img-joomir">';
								...
								echo '</a><div class="grid-inner_content"><div class="category_name">
								<a href="'. get_term_link($cat->slug, 'product_cat') .'""><span>';
								...
								echo '</span></a></div>';
								echo '<div class="category_description"><p>';
