		...
		public function breadcrumb_html($themes)
			{
				...
				elseif( is_home())
				...
				else if(is_attachment())
					{
						...
						if($breadcrumb_display_home == 'yes')
							{
$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="'.__('Home','breadcrumb').'" href="'.get_bloginfo('url').'">'.__('فروشگاه اینترنتی','breadcrumb').'</a></li>';							}
