...
if ( ! class_exists( 'AWS_Markup' ) ) :
    ...
    class AWS_Markup {
        ...
        public function markup() {
            ...
            $markup = '';
            $markup .= '<button class="rd-navbar-search-toggle rd-navbar-fixed-element-2 toggle-original" data-rd-navbar-toggle="#rd-navbar-search-1" id="open-btn""><span>	</span></button><div class="aws-container" ' . $params_string . '>';
            $markup .= '<form class="aws-search-form" action="' . home_url('/') . '" method="get" role="search" >';

            $markup .= '<div class="aws-wrapper search-joomir">';
